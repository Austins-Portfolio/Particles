...
import particles.mod.ModLoader;
...
public class ParticlePallet {
	...
	public void buildPallet(JFrame frame, World world) {
		...
		ArrayList<SelectionItem> list_a = new ArrayList<SelectionItem>();
		list_a.add(water);
		list_a.add(watervapor);
		list_a.add(lava);
		list_a.add(wall);
		list_a.add(rock);
		list_a.add(acid);
		list_a.add(acidvapor);
		list_a.add(glass);
		list_a.add(fire);
		list_a.add(smoke);
		list_a.add(plasma);
		list_a.add(spawnerparticle);
		list_a.add(voidparticle);
		list_a.add(oil);
		list_a.add(gasoline);
		
		list_a.addAll(ModLoader.items);
		
		SelectionItem[] list = new SelectionItem[list_a.size()];
		list_a.toArray(list);
